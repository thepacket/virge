<!--
  ...
  Any PR opened here will be closed automatically. See CONTRIBUTING.md.

  Bug reports — especially about incorrect biology — are welcome as issues.
  To take the code in your own direction, fork it: the MIT licence allows it.
-->
